...
$pdf->SetFont('Arial','',10);
$pdf->Cell(50,50,'S.No.');
$pdf->Cell(100,50,$_POST['pt41']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Name of Research Paper');
$pdf->Cell(300,50,$_POST['pt42']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Details of Publication');
$pdf->Cell(100,50,$_POST['pt43']);
$pdf->Ln(5);
$pdf->Cell(50,50,'ISSN No/UGC No');
$pdf->Cell(100,50,$_POST['pt44']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Impact Factor');
$pdf->Cell(100,50,$_POST['pt45']);
$pdf->Ln(10);
//Publication5
$pdf->SetFont('Arial','',10);
$pdf->Cell(50,50,'S.No.');
$pdf->Cell(100,50,$_POST['pt51']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Name of Research Paper');
$pdf->Cell(300,50,$_POST['pt52']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Details of Publication');
$pdf->Cell(100,50,$_POST['pt53']);
$pdf->Ln(5);
$pdf->Cell(50,50,'ISSN No/UGC No');
$pdf->Cell(100,50,$_POST['pt54']);
$pdf->Ln(5);
$pdf->Cell(50,50,'Impact Factor');
$pdf->Cell(100,50,$_POST['pt55']);
$pdf->Ln(10);
